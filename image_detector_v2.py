...
class Ui_MainWindow(QObject):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.select_object.setItemText(0, _translate("MainWindow", "Cats or Dogs"))
        self.select_object.setItemText(1, _translate("MainWindow", "LiveCam"))
        self.select_object.setItemText(2, _translate("MainWindow", "LiveCam/RandomObjects"))
    ...
    def process(self):
        if str(self.file_path.text()) == "":
            ...
            if str(self.select_object.currentText()) == "Cats or Dogs": 
                self.detect_dogs() 
